...
<ul>
  ...
  <li>Use <a href="<?php echo e(route('user-guide.show', 'using-filters')); ?>">filters</a> to find imported entries</li>
  <li><a href="<?php echo e(route('user-guide.show', 'editing-entries')); ?>">Edit entries</a> to add additional information</li>
  <li>Check the <a href="<?php echo e(route('user-guide.show', 'compliance-now')); ?>">Compliance Now</a> page to see imported entries</li>
</ul>

<?php /**PATH C:\xampp\htdocs\DP\isqmapp\resources\views/user-guide/topics/importing-data.blade.php ENDPATH**/ ?>