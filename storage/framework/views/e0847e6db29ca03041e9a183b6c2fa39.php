...
<body>
    <nav>
        <div class="nav-content">
            ...
            <div class="nav-links">
                ...
                <a href="<?php echo e(route('pages.features')); ?>">Features</a>
        ...
        <div class="hero-content">
            ...
            <div class="cta-buttons">
                <?php if(auth()->guard()->check()): ?>
                    ...
                    <a href="<?php echo e(route('pages.features')); ?>" class="btn-secondary">Learn More</a>
                <?php else: ?>
                    <a href="<?php echo e(route('login')); ?>" class="btn-primary">Sign In</a>
                    <a href="<?php echo e(route('pages.features')); ?>" class="btn-secondary">View Features</a>
                <?php endif; ?>
            </div>
        </div>
    </section>
    ...
    <section class="features" id="features">
        ...
        <div style="text-align: center; margin-top: 40px;">
            <a href="<?php echo e(route('pages.features')); ?>" class="btn-primary" style="display: inline-block;">View All Features →</a>
        </div>
    </section>
        ...
        <div class="footer-content">
            ...
            <div class="footer-section">
                ...
                <ul>
                    ...
                    <li><a href="<?php echo e(route('settings.edit')); ?>">Settings</a></li>
...
<?php /**PATH C:\xampp\htdocs\DP\isqmapp\resources\views/welcome.blade.php ENDPATH**/ ?>