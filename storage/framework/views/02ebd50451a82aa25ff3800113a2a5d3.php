...
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($title)]); ?>
  <div style="max-width:720px;margin:20px auto;">
    ...
    <form method="post" 
          ...
          class="create-form"
          onsubmit="return confirmCreateItem('client')">
      <?php echo csrf_field(); ?>
      ...
      <input type="text" name="industry" style="width:100%;padding:8px;border:1px solid #d1d5db;border-radius:6px;">
      ...
      <input type="text" name="phone" style="width:100%;padding:8px;border:1px solid #d1d5db;border-radius:6px;">
...
<?php /**PATH C:\xampp\htdocs\DP\isqmapp\resources\views/clients/create.blade.php ENDPATH**/ ?>