...
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($title)]); ?>
  ...
  <div style="max-width:1400px; margin:0 auto; padding:0 12px;">
    ...
    <form method="post" 
          action="<?php echo e(route('isqm.store')); ?>" 
        ...
        <div class="form-row">
          <div>
            ...
            <select name="area" required>
              <?php $__currentLoopData = $areas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <option value="<?php echo e($key); ?>" <?php if(old('area', request('area')) === $key): echo 'selected'; endif; ?>><?php echo e($label); ?></option>
          ...
          <div>
            ...
            <select name="status" required>
              <option value="open" <?php if(old('status') === 'open'): echo 'selected'; endif; ?>>Open</option>
              <option value="monitoring" <?php if(old('status') === 'monitoring'): echo 'selected'; endif; ?>>Monitoring</option>
              <option value="closed" <?php if(old('status') === 'closed'): echo 'selected'; endif; ?>>Closed</option>
            </select>
          </div>
        </div>
        ...
        <div class="dynamic-field-group" data-field-name="quality_objective">
          ...
          <div class="dynamic-fields-container">
            <div class="dynamic-field-item">
              <textarea name="quality_objective[]" rows="4" required><?php echo e(old('quality_objective.0')); ?></textarea>
      ...
      <div class="form-section">
        ...
        <div class="dynamic-field-group" data-field-name="quality_risk">
          ...
          <div class="dynamic-fields-container">
            <div class="dynamic-field-item">
              <textarea name="quality_risk[]" rows="4"><?php echo e(old('quality_risk.0')); ?></textarea>
              <button type="button" class="btn-remove-field" style="display:none;margin-top:8px;padding:6px 12px;background:#ef4444;color:white;border:none;border-radius:4px;cursor:pointer;font-size:12px;">Remove</button>
            </div>
          </div>
        ...
        <div class="dynamic-field-group" data-field-name="assessment_of_risk">
          ...
          <div class="dynamic-fields-container">
            <div class="dynamic-field-item">
              <textarea name="assessment_of_risk[]" rows="4"><?php echo e(old('assessment_of_risk.0')); ?></textarea>
              <button type="button" class="btn-remove-field" style="display:none;margin-top:8px;padding:6px 12px;background:#ef4444;color:white;border:none;border-radius:4px;cursor:pointer;font-size:12px;">Remove</button>
            </div>
          </div>
        ...
        <div class="form-row-3">
          <div>
            ...
            <select name="likelihood">
              <option value="">—</option>
              <option value="1" <?php if(old('likelihood') === '1'): echo 'selected'; endif; ?>>Yes</option>
              <option value="0" <?php if(old('likelihood') === '0'): echo 'selected'; endif; ?>>No</option>
            </select>
          </div>
          <div>
            ...
            <select name="adverse_effect">
              <option value="">—</option>
              <option value="1" <?php if(old('adverse_effect') === '1'): echo 'selected'; endif; ?>>Yes</option>
              <option value="0" <?php if(old('adverse_effect') === '0'): echo 'selected'; endif; ?>>No</option>
            </select>
          </div>
          <div>
            ...
            <select name="risk_applicable">
              <option value="">—</option>
              <option value="1" <?php if(old('risk_applicable') === '1'): echo 'selected'; endif; ?>>Yes</option>
              <option value="0" <?php if(old('risk_applicable') === '0'): echo 'selected'; endif; ?>>No</option>
            </select>
          </div>
        </div>
        ...
        <div class="dynamic-field-group" data-field-name="response">
          ...
          <div class="dynamic-fields-container">
            <div class="dynamic-field-item">
              <textarea name="response[]" rows="4"><?php echo e(old('response.0')); ?></textarea>
              <button type="button" class="btn-remove-field" style="display:none;margin-top:8px;padding:6px 12px;background:#ef4444;color:white;border:none;border-radius:4px;cursor:pointer;font-size:12px;">Remove</button>
            </div>
          </div>
        ...
        <div class="dynamic-field-group" data-field-name="firm_implementation">
          ...
          <div class="dynamic-fields-container">
            <div class="dynamic-field-item">
              <textarea name="firm_implementation[]" rows="4"><?php echo e(old('firm_implementation.0')); ?></textarea>
              <button type="button" class="btn-remove-field" style="display:none;margin-top:8px;padding:6px 12px;background:#ef4444;color:white;border:none;border-radius:4px;cursor:pointer;font-size:12px;">Remove</button>
            </div>
          </div>
        ...
        <div class="dynamic-field-group" data-field-name="toc">
          ...
          <div class="dynamic-fields-container">
            <div class="dynamic-field-item">
              <textarea name="toc[]" rows="4"><?php echo e(old('toc.0')); ?></textarea>
              <button type="button" class="btn-remove-field" style="display:none;margin-top:8px;padding:6px 12px;background:#ef4444;color:white;border:none;border-radius:4px;cursor:pointer;font-size:12px;">Remove</button>
            </div>
          </div>
      ...
      <div class="form-section">
          ...
          <div>
            ...
            <select name="monitoring_activity_id">
              ...
              <?php $__currentLoopData = $monitoringActivities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <option value="<?php echo e($m->id); ?>" <?php if(old('monitoring_activity_id') == $m->id): echo 'selected'; endif; ?>><?php echo e($m->name); ?></option>
              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </select>
          </div>
          <div>
            ...
            <select name="deficiency_type_id">
              ...
              <?php $__currentLoopData = $deficiencyTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <option value="<?php echo e($d->id); ?>" <?php if(old('deficiency_type_id') == $d->id): echo 'selected'; endif; ?>><?php echo e($d->name); ?></option>
              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </select>
          </div>
        </div>
        ...
        <div class="dynamic-field-group" data-field-name="findings">
          ...
          <div class="dynamic-fields-container">
            <div class="dynamic-field-item">
              <textarea name="findings[]" rows="4"><?php echo e(old('findings.0')); ?></textarea>
              <button type="button" class="btn-remove-field" style="display:none;margin-top:8px;padding:6px 12px;background:#ef4444;color:white;border:none;border-radius:4px;cursor:pointer;font-size:12px;">Remove</button>
            </div>
          </div>
        ...
        <div class="dynamic-field-group" data-field-name="root_cause">
          ...
          <div class="dynamic-fields-container">
            <div class="dynamic-field-item">
              <textarea name="root_cause[]" rows="4"><?php echo e(old('root_cause.0')); ?></textarea>
              <button type="button" class="btn-remove-field" style="display:none;margin-top:8px;padding:6px 12px;background:#ef4444;color:white;border:none;border-radius:4px;cursor:pointer;font-size:12px;">Remove</button>
            </div>
          </div>
        ...
        <div class="checkbox-group">
          <label><input type="checkbox" name="severe" value="1" <?php if(old('severe')): echo 'checked'; endif; ?>> Severe</label>
          <label><input type="checkbox" name="pervasive" value="1" <?php if(old('pervasive')): echo 'checked'; endif; ?>> Pervasive</label>
          <label><input type="checkbox" name="objective_met" value="1" <?php if(old('objective_met')): echo 'checked'; endif; ?>> Objective Met</label>
        </div>
        ...
        <div class="dynamic-field-group" data-field-name="remedial_actions">
          ...
          <div class="dynamic-fields-container">
            <div class="dynamic-field-item">
              <textarea name="remedial_actions[]" rows="4"><?php echo e(old('remedial_actions.0')); ?></textarea>
              <button type="button" class="btn-remove-field" style="display:none;margin-top:8px;padding:6px 12px;background:#ef4444;color:white;border:none;border-radius:4px;cursor:pointer;font-size:12px;">Remove</button>
            </div>
          </div>
      ...
      <div class="form-section">
          ...
          <div>
            ...
            <select name="owner_id">
              ...
              <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $u): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <option value="<?php echo e($u->id); ?>" <?php if(old('owner_id') == $u->id): echo 'selected'; endif; ?>><?php echo e($u->name); ?></option>
              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </select>
          </div>
        </div>
        ...
        <div class="form-row">
          ...
          <div>
            ...
            <input type="date" name="review_date" value="<?php echo e(old('review_date')); ?>">
          </div>
        </div>

        <div class="checkbox-group">
          <label><input type="checkbox" name="entity_level" value="1" <?php if(old('entity_level')): echo 'checked'; endif; ?>> Entity Level</label>
          <label><input type="checkbox" name="engagement_level" value="1" <?php if(old('engagement_level')): echo 'checked'; endif; ?>> Engagement Level</label>
        </div>
      </div>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\DP\isqmapp\resources\views/isqm/create.blade.php ENDPATH**/ ?>