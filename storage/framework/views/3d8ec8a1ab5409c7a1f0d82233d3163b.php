...
<ul>
  <li><a href="<?php echo e(route('user-guide.show', 'creating-entries')); ?>">Create entries</a> and associate them with clients</li>
  <li>Use <a href="<?php echo e(route('user-guide.show', 'using-filters')); ?>">filters</a> to find entries by client</li>
  <li>Generate <a href="<?php echo e(route('user-guide.show', 'reports-exports')); ?>">reports</a> filtered by client</li>
</ul>

<?php /**PATH C:\xampp\htdocs\DP\isqmapp\resources\views/user-guide/topics/managing-clients.blade.php ENDPATH**/ ?>