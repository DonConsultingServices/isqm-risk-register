...
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($title)]); ?>
  ...
  <div class="guide-container">
    <div class="guide-header">
      ...
      <div class="guide-nav">
        <a href="<?php echo e(route('user-guide.index')); ?>">← Back to Guide</a>
        <div class="topic-selector">
          <select onchange="if(this.value) window.location.href=this.value">
            <option value="">Select a topic...</option>
            <?php $__currentLoopData = $topics; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $topicTitle): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <option value="<?php echo e(route('user-guide.show', $key)); ?>" <?php echo e($key === $topic ? 'selected' : ''); ?>><?php echo e($topicTitle); ?></option>
      ...
      <div class="guide-nav" style="margin-top: -12px;">
        <?php $__currentLoopData = $topics; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $topicTitle): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <?php if($key !== $topic): ?>
            <a href="<?php echo e(route('user-guide.show', $key)); ?>"><?php echo e($topicTitle); ?></a>
          <?php else: ?>
            <a href="<?php echo e(route('user-guide.show', $key)); ?>" class="active"><?php echo e($topicTitle); ?></a>
          <?php endif; ?>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
      </div>
    </div>
    ...
    <div class="guide-content">
      <?php echo $__env->make("user-guide.topics.{$topic}", array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    </div>

    <div class="back-link">
      <a href="<?php echo e(route('user-guide.index')); ?>">← Back to User Guide</a>
    </div>
  </div>
...
<?php /**PATH C:\xampp\htdocs\DP\isqmapp\resources\views/user-guide/show.blade.php ENDPATH**/ ?>