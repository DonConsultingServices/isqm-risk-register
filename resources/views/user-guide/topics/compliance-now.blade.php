...
<ul>
  <li><a href="{{ route('user-guide.show', 'editing-entries') }}">Edit entries</a> to update information</li>
  <li>Use <a href="{{ route('user-guide.show', 'reports-exports') }}">reports and exports</a> to generate compliance documentation</li>
  <li>Review <a href="{{ route('user-guide.show', 'isqm-areas') }}">ISQM areas</a> to understand the compliance requirements</li>
</ul>
